...
public class MainForExactPrintTableACHPWY {
...
//        }
        PrioriBestPrHelperACHPWY helper = new PrioriBestPrHelperACHPWY(maxMemoryByte / 8, queryN, 0, 1);
...
//            System.out.println("\t\t\t+\t+delta:\t"+err+"\t\t"+Math.log(err/errED)*(pNum-1)/Math.log(errST/errED)+"\t\t"+Math.log(errST/errED));
        ...
        MainForExactPrintTableACHPWY main;

        main = new MainForExactPrintTableACHPWY();
