...
public class GKSketchUdf {
  ...
  public GKSketchUdf(int maxMemoryByte) {
    int maxBufferNum=maxMemoryByte/2/8;
    int maxEntryNum = maxMemoryByte/2/8/3;
    this.rankAccuracy = 1.0/(maxBufferNum-1);
    this.entries = new ArrayList<>(maxBufferNum);
    this.incoming = new double[maxBufferNum];
    this.incomingIndex = 0;
    this.minValue = Double.MAX_VALUE;
    this.compressedCount = 0;
  }
  public GKSketchUdf(double rankAccuracy) {
